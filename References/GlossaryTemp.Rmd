...
# Define the jQuery dependency with a specific version
jquery_dep <- htmlDependency(
  name = "jquery",
  version = "3.5.1",
  src = c(href = "https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/"),
  script = "jquery.min.js"
)

# Attach the jQuery dependency to the document
attachDependencies(tags$head(), jquery_dep)
```
