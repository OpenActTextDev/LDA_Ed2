...
*Chapter Preview*. In Chapter \@ref(ChapSeverity) we explored the use of continuous as well as mixture distributions to model the random size of loss. Often the risk of loss is shared between the policyholder (the insured) and the insurer. Sharing risk can take the form of a deductible that is paid out-of-pocket of the insured before the insurer contributes to the loss, the form of a limit that caps the insured’s liability for loss to a certain amount, or the form of a portion of the loss the insurer is responsible for covering after the insured covers his/her share of the cost, among other forms of cost-sharing. In Sections \@ref(S:PolicyDeduct) to \@ref(S:CoinsInf) we introduce the policy deductible feature of the insurance contract, the limited policy, and the co-insurance cost-sharing arrangement. In Section \@ref(S:Chap5Reinsurance) we explore how insurance companies transfer part of the underlying insured risk by securing coverage from a reinsurer. Section \@ref(S:MS:ModifiedData1) covers parametric estimation methods for modified data including grouped, censored and truncated data. In Section \@ref(S:MS:NonParModified) we apply some non-parametric estimation tools like the ogive estimator, the plug-in principle, the Kaplan-Meier product-limit estimator, and the Nelson Aalon estimator on the modified data.
...
**Example 5.1.1. Actuarial Exam Question.**
...
**Example 5.1.2. Actuarial Exam Question.**
For an insurance:
...
**Example 5.1.3. Actuarial Exam Question.**
You are given:
...
**Example 5.1.4. Actuarial Exam Question.**
...
### Coinsurance and Inflation {#S:CoinsInf}
...
### Reinsurance {#S:Chap5Reinsurance}
...
**Example 5.1.6. Actuarial Exam Question.**
...
**Example 5.2.1. Actuarial Exam Question.** 
You are given:
...
**Example 5.2.2. Actuarial Exam Question.**
You are given:
...
**Example 5.2.3. Actuarial Exam Question.**
