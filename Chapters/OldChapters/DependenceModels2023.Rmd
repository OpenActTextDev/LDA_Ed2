...
### Rank Based Measures {#Sec:RankMeasures}
...
(ref:IndCop) **Independence Copula.** Left: Scatterplot of observations from Independence Copula. Right: Plot for distribution function for Independence Copula.
...
(ref:FrankCop) **Frank's Copula**. Left: Plot for distribution function for Frank's Copula. Right:Plot for density function for Frank's Copula
