...
Although our focus is on data from continuous distributions, the same process can be used for discrete versions or data that come from a hybrid combination of discrete and
...
summarize model goodness of fit. [Table 6.1](#tab:6.1) provides three
...
data, a *goodness of fit* statistic is generally preferred as it is more intuitive
...
**Example 6.6.1. Bodily Injury Claims.** For the Boston auto bodily
injury claims data from Example 5.3.2, we include the full dataset with
...
**Example 6.6.2. Bodily Injury Claims.** For the Boston auto bodily
