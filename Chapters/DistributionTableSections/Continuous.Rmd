...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'Par1A')">Exponential</button>
  <button class="tablinks" onclick="openTab(event, 'Par1B')">Inv Exponential</button>
  <button class="tablinks" onclick="openTab(event, 'Par1C')">Single Parameter Pareto</button>
</div>


<div id="Par1A" class="tabcontent">
...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'Par2A')">Pareto</button>
  <button class="tablinks" onclick="openTab(event, 'Par2B')">Inv Pareto</button>
  <button class="tablinks" onclick="openTab(event, 'Par2C')">Loglogistic</button>
  <button class="tablinks" onclick="openTab(event, 'Par2D')">Paralogistic</button>
  <button class="tablinks" onclick="openTab(event, 'Par2E')">Gamma</button>
  <button class="tablinks" onclick="openTab(event, 'Par2F')">Inv Gamma</button>
  <button class="tablinks" onclick="openTab(event, 'Par2G')">Weibull</button>
  <button class="tablinks" onclick="openTab(event, 'Par2H')">Inv Weibull</button>
  <button class="tablinks" onclick="openTab(event, 'Par2I')">Uniform</button>
  <button class="tablinks" onclick="openTab(event, 'Par2J')">Normal</button>
</div>

<div id="Par2A" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright"><button>Hide</button></span>
...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'Par3A')">Generalized Pareto</button>
  <button class="tablinks" onclick="openTab(event, 'Par3B')">Burr</button>
  <button class="tablinks" onclick="openTab(event, 'Par3C')">Inv Burr</button>
</div>

<div id="Par3A" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright"><button>Hide</button></span>
...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'Par4')">GB2</button>  
</div>

<div id="Par4" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright"><button>Hide</button></span>
