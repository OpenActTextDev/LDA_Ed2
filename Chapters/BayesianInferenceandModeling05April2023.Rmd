...
```{r ChBayesBayesianTossAnimation, fig.cap='(ref:ChBayesBayesianTossAnimation)', out.width = '80%', fig.asp = 0.75, eval = ANIMATION, echo=SHOW_PDF}
...
knitr::include_graphics("Figures/ThomasBayes.png")
```
